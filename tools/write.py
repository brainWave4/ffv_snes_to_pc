...
def binaryData(rommap):
    ...
    for d in [
        ...
        {DICT_FILE: "world_tile_attr0", DICT_ADDR: 0xff9c0, DICT_END: 0xffac0},
        {DICT_FILE: "world_tile_attr1", DICT_ADDR: 0xffac0, DICT_END: 0xffbc0},
        {DICT_FILE: "world_tile_attr2", DICT_ADDR: 0xffbc0, DICT_END: 0xffcc0},
